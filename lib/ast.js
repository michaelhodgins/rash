 ...
 */
var FontFace, Function, Import, Literal, MediaQuery, MsViewport, Namespace, Page, ParameterList, Property, Rule, StyleSheet, ValueGroup;
...
MsViewport = (function() {
  function MsViewport(properties) {
    this.properties = properties;
  }

  MsViewport.prototype.toCSS = function() {
    var properties;
    properties = this.properties.map(function(property) {
      return property.toCSS();
    }).join(";");
    return "@-ms-viewport {" + properties + "}";
  };
